<template>
  <div class="weather-dealy">
    <div class="date">
      
      <div>Aujourd'hui:<br>{{ dateBuilder(weather.forecast[0].datetime) }}</div>
      <i :class="weatherTransalte(weather.forecast[0].weather)"></i>
    </div>
    <div class="temp">
      temperature minimum : <br> <div class="temp-min">{{ weather.forecast[0].tmin }}C</div>
      temperature maximum : <br> <div class="temp-max">{{ weather.forecast[0].tmax }}C</div>
    </div>
  </div>
</template>
